<section class="adding-post__photo tabs__content tabs__content--active">
    ...
    <form class="adding-post__form form" action="/add.php?adding-type_id=1" method="post" enctype="multipart/form-data">
        ...
        <div class="adding-post__input-file-container form__input-container form__input-container--file">
            <div class="adding-post__input-file-wrapper form__input-file-wrapper">
                <div class="adding-post__file-zone adding-post__file-zone--photo form__file-zone dropzone">
                    <input class="adding-post__input-file form__input-file" id="userpic-file-photo" type="file" name="picture" title=" ">
